...
class ffhUI(Frame):
    ...
    def __draw_new_draft_window(self, parent):
        ...
        def begin_draft():
            ...
            self.game.opponentteams = []
            
            for x in xrange(self.game.numberofopponents):
                self.game.opponentteams.append([])
            
            if self.game.draftstyle == "Linear":
            
                print self.game.opponentteams
                
                for x in xrange(self.game.draftposition):
                    self.__draw_new_opponent_choice_window(self.parent, x)
                    
                self.__MainUI()
                
                for x in xrange(self.game.draftposition, self.game.numberofopponents + 1):
                    self.__draw_new_opponent_choice_window(self.parent, x)
        ...
        def begin_draft():
            ...
            if self.game.draftstyle == "Linear":
                ...
                if self.game.draftposition == 1:
                    ...
                    OpponentChoiceUI(window_frame, self.game, 1)
...
class MainUI(Frame):
    ...
    def __draw_current_choice(self, parent):
        ...
        def pickplayer():
            ...
            OpponentChoiceUI(self.parent, self.game, self.game.draftposition + 1)
